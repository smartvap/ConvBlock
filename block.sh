...
iptables -t raw -A PREROUTING -p tcp -m multiport --dports 22 179 1080 1180 1181 1183 2380 8080 10250 10256 10257 10259 12300 12301 12302 -j DROP
iptables -t raw -A PREROUTING -p tcp -m multiport --dports 12303 12304 12305 -j DROP
