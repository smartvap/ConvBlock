...
declare -A mapParaSpec=(
   ...
   ["--alternate-python3"]="Switch the Python 3 runtime environment to the current compiled version."
   ["--alternate-pip3"]="Switch the PIP 3 version to the current compiled version."
